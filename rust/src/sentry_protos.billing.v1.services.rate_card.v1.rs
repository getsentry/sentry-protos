...
pub struct SpendAllocationSegment {
    #[prost(uint64, tag = "1")]
    pub project_id: u64,
    #[prost(uint64, tag = "2")]
    pub quantity: u64,
...
pub struct RateCardLineItem {
    ...
    pub spend_allocation_segments: ::prost::alloc::vec::Vec<SpendAllocationSegment>,
