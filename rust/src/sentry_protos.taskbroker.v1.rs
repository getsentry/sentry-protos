...
impl OnAttemptsExceeded {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "ON_ATTEMPTS_EXCEEDED_UNSPECIFIED",
            Self::Discard => "ON_ATTEMPTS_EXCEEDED_DISCARD",
            Self::Deadletter => "ON_ATTEMPTS_EXCEEDED_DEADLETTER",
        }
    }
...
pub mod worker_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn push_task(
            ...
            tonic::Response<super::PushTaskResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "sentry_protos.taskbroker.v1.WorkerService",
                        "PushTask",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod worker_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "sentry_protos.taskbroker.v1.WorkerService";
