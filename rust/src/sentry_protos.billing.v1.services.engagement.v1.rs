...
pub struct AddMonetaryGrantRequest {
    #[prost(uint64, tag = "1")]
    ...
    #[prost(enumeration = "RecurringCreditType", optional, tag = "5")]
    pub r#type: ::core::option::Option<i32>,
    /// Omit for a one-time balance top-up. When set, creates a recurring credit
    /// for this many billing periods.
    #[prost(uint64, optional, tag = "6")]
    pub number_of_periods: ::core::option::Option<u64>,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct AddMonetaryGrantResponse {}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct AddUnitGrantRequest {
    #[prost(uint64, tag = "1")]
    pub organization_id: u64,
    #[prost(uint64, tag = "2")]
    pub contract_id: u64,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAvailableTrialsRequest {
    #[prost(uint64, tag = "1")]
    pub organization_id: u64,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetAvailableTrialsResponse {
...
pub struct RedeemPromoCodeResponse {
    ...
    pub claimed: bool,
    #[prost(uint64, optional, tag = "2")]
    pub trial_days: ::core::option::Option<u64>,
