...
pub struct GetAllocationCapacityForContractRequest {
    #[prost(uint64, tag = "1")]
    pub contract_id: u64,
}
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ProjectAllocationCapacity {
    #[prost(uint64, tag = "1")]
    pub project_id: u64,
    #[prost(uint64, tag = "2")]
...
pub struct LineItemAllocationCapacity {
    #[prost(string, tag = "1")]
    ...
    #[prost(bool, tag = "2")]
    pub has_remaining_shared_capacity: bool,
    #[prost(message, repeated, tag = "3")]
    pub project_allocations: ::prost::alloc::vec::Vec<ProjectAllocationCapacity>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetAllocationCapacityForContractResponse {
    #[prost(message, repeated, tag = "1")]
    pub line_item_capacities: ::prost::alloc::vec::Vec<LineItemAllocationCapacity>,
}
