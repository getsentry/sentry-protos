...
pub struct PendingChange {
    ...
    /// New contract sponsored_type, holding a SponsoredType enum value (defined
    /// in services/contract/v1/billing_config.proto). Stored as a raw int rather
    /// than the enum so the common package does not depend on a service package.
    /// SPONSORED_TYPE_UNSPECIFIED (0) clears the sponsorship; an unset field
    /// leaves it unchanged.
    #[prost(uint32, optional, tag = "4")]
    pub sponsored_type: ::core::option::Option<u32>,
}
