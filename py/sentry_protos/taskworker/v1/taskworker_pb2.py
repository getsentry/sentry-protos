...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PUSHTASKRESPONSE']._serialized_end=261
  _globals['_WORKERSERVICE']._serialized_start=263
  _globals['_WORKERSERVICE']._serialized_end=385
