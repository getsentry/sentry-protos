...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_PUSHTASKRESPONSE']._serialized_end=241
  _globals['_WORKERSERVICE']._serialized_start=243
  _globals['_WORKERSERVICE']._serialized_end=365
